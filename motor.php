...
<body>
  ...
  //echo "-------------------------------------";    
    ...
    echo "<input type=\"submit\" value=\"Siguiente\" name=\"Siguiente\" style='width:200px; height:40px'/>";
      ...
      /*if ($codProceso=='P2') {
      echo "<input type=\"submit\" value=\"Anterior\" name=\"Anterior\" style='width:200px; height:40px'/>";
      echo "<a href=\"login/login.php\"><button type=\"button\" class=\"register_btn\" style='width:200px; height:40px'>Siguiente</button></a>";
      //echo "<input type=\"submit\" value=\"Siguiente\" name=\"Siguiente\" style='width:200px; height:40px'/>";
      }else{*/
      echo "<input type=\"submit\" value=\"Anterior\" name=\"Anterior\" style='width:200px; height:40px'/ class=\"anterior\">";
      echo "<input type=\"submit\" value=\"Siguiente\" name=\"Siguiente\" style='width:200px; height:40px'/>";
    //}
    }
  }
